...
const Blog = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-start w-full p-5 py-2 text-black gap-4">
      ...
      <section className="flex gap-4 text-white p-1">
        <div className="flex flex-col justify-center items-center">
          <div className="w-16 h-16 rounded-full bg-black overflow-hidden outline-2 outline-blue-400 outline-offset-2 mb-2">
            <img
              src={image}
              alt="pfp"
          ...
          <p className="text-xs truncate w-20 overflow-hidden whitespace-nowrap text-center">
            Testingtesting
          </p>
        </div>
      </section>
      ...
      {posts.map((post) => (
        ...
        >
          ...
          <div className="py-2 px-2">
            <p className="text-xs">
              <span className="font-black">{post.author}</span> {post.content}
            </p>
          </div>
        </div>
      ))}
